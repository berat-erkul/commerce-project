...
/**
 * Typed event/command record'larını OutboxEvent satırına çevirir.
 * <p>
 * Header standardı: her outbox satırı en az şunları taşır:
 *   - saga-instance-id  (correlation id)
 *   - event-type        (ProcessPayment, ReserveStock, OrderCompleted, ...)
 *   - command-id veya event-id
 */
@Component
